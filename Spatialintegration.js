...
function createAnalysisButtons() {
  ...
  // Botón: Analizar Densidad
  const btnDensity = document.createElement('button');
  btnDensity.className = 'btn-action btn-analysis';
  btnDensity.id = 'btnAnalyzeDensity';
  btnDensity.title = 'Detectar densidad urbano-rural';
  btnDensity.innerHTML = `
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      <circle cx="12" cy="12" r="10"/>
      <path d="M12 6v6m0 0h6"/>
    </svg>
    <span>Analizar Densidad</span>
  `;
  btnDensity.onclick = analyzeUrbanRuralDensity;

  // Botón: Generar Buffers Dinámicos
  const btnDynamicBuffers = document.createElement('button');
  btnDynamicBuffers.className = 'btn-action btn-analysis';
  btnDynamicBuffers.id = 'btnDynamicBuffers';
  btnDynamicBuffers.title = 'Generar buffers adaptativos';
  btnDynamicBuffers.innerHTML = `
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <span>Buffers Dinámicos</span>
  `;
  btnDynamicBuffers.onclick = generateDynamicBuffers;

  // Botón: Spatial Join
  const btnSpatialJoin = document.createElement('button');
  btnSpatialJoin.className = 'btn-action btn-analysis';
  btnSpatialJoin.id = 'btnSpatialJoin';
  btnSpatialJoin.title = 'Ejecutar spatial join';
  btnSpatialJoin.innerHTML = `
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  btnExport.className = 'btn-action btn-analysis';
  btnExport.id = 'btnExportResults';
  btnExport.title = 'Exportar resultados';
  btnExport.innerHTML = `
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  // Agregar botones
  topbarRight.insertBefore(btnDensity, topbarRight.firstChild);
  topbarRight.insertBefore(btnDynamicBuffers, btnDensity.nextSibling);
  topbarRight.insertBefore(btnSpatialJoin, btnDynamicBuffers.nextSibling);
  topbarRight.insertBefore(btnExport, btnSpatialJoin.nextSibling);

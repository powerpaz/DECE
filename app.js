...
function exportToCSV() {
  ...
  // REMOVED: assignOrphanSatellites
...
// OLD assignOrphanSatellites removed);
  });
...
function processData(data) {
  ...
  // Guardar en globalData con TODOS los datos necesarios
  globalData = {
    nucleos,
    satellites,
    satCandidates,
  ...
  // AHORA sí, ejecutar asignación forzada
  executeOrphanAssignment();
  
  hideLoadingOverlay();
  console.log(`[OK] Datos cargados: ${nucleos.length} núcleos, ${satellites.length} satélites`);
}
